> * 原文地址：[github.com/donnemartin/system-design-primer-ultra](https://github.com/donnemartin/system-design-primer-ultra)
...
> * 这个 [链接](https://github.com/xitu/system-design-primer-ultra/compare/master...donnemartin:master) 用来查看本翻译与英文版是否有差别（如果你没有看到 README.md 发生变化，那就意味着这份翻译文档是最新的）。
...
* 完善章节
* 添加章节
* [帮助翻译](https://github.com/donnemartin/system-design-primer-ultra/issues/28)
