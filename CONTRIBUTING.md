...
For bug reports or requests [submit an issue](https://github.com/donnemartin/system-design-primer-ultra/issues).

## Pull Requests

The preferred way to contribute is to fork the
[main repository](https://github.com/donnemartin/system-design-primer-ultra) on GitHub.

1. Fork the [main repository](https://github.com/donnemartin/system-design-primer-ultra).  Click on the 'Fork' button near the top of the page.  This creates a copy of the code under your account on the GitHub server.

2. Clone this copy to your local disk:

        $ git clone git@github.com:YourLogin/system-design-primer-ultra.git
...
6. Finally, go to the web page of your fork of the `system-design-primer-ultra` repo and click 'Pull Request' to send your changes for review.
